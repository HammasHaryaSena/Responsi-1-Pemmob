package com.example.responsi1mobileh1d023062.viewmodel
...
import com.example.responsi1mobileh1d023062.data.model.Coach
import com.example.responsi1mobileh1d023062.data.model.Player
import com.example.responsi1mobileh1d023062.data.network.RetrofitInstance
...
class TeamViewModel : ViewModel() {
    ...
    fun fetchCoach() {
        viewModelScope.launch {
            try {
                val response = RetrofitInstance.api.getTeamById(19)
